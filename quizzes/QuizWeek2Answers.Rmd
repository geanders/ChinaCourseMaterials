...
Some of the faculty from Johns Hopkins' Department of Biostatistics offer courses on Data Science that you don't have to pay for through Coursera, which is a platform for Massive Open Online Courses. Further, they put all their course materials on GitHub accounts, where others can clone their repositories and modify things as they want for their own use and to share with others. Based on this information, how would you describe these courses and their associated materials?
...
> **Answer c.** 
> Explanation: This course does not cost anything for you to take, and you can also get all of the course materials for free through GitHub. That makes it "free as in beer". Also, you can get, change, and pass along any of the materials that you want. For example, you could probably use some of these materials as a starting point if you were designing an R workshop, as long as you properly attribute where you got them from. This makes the course and materials "Free as in speech". For a bit more about Open Courseware, see check out [this](https://en.wikipedia.org/wiki/OpenCourseWare).
...
When you run `install.packages("ggplot2")`, where is the package `ggplot2` being downloaded from?

a. GitHub
b. Directly from RStudio's website
c. It's not, it's already on your computer
d. CRAN

> **Answer d.**
> Unless you put some special options in the `install.packages()` function, it will try to get the package from CRAN and will fail if it can't find it there. 
...
This is the eleventh question in the quiz. What does this mean?

a. You'll need to get more questions right over all the quizzes to get full credit, because the quiz grade is determined by the percent of all questions you get correct.
b. Having this extra question, above the 10 guaranteed for this quiz, will make it easier for you to get full credit for quiz points, because you only need to get 60 total questions right (60 * 1 / 3 = 20 points) to get full credit for the quiz part of your total course score.
c. Any of these extra questions, beyond the 10 required on each quiz, will count as extra credit, so you could potentially get more than 20 points for the Quiz component of your final course score. 
d. Your answer to this question doesn't matter, because any questions beyond the 10 required on each quiz will not be graded.

> **Answer b.**
> You cannot get more than 20 points on your final course grade from the quizzes. Once you have answered 60 quiz questions correctly, you will have the total possible credit for this component (60 \* 1/3 point per right question). I am guaranteeing that each quiz will have at least 10 questions, but if they have more, that's just more chances for you to get to that bar of 60 correct answers. The grade is **not** based on the percentage of all questions you get right. You can **not** get extra credit from the quizzes (just from the extra credit project).